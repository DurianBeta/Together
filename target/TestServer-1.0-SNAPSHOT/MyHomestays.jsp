...
<body>
    ...
    <div class="super_container">
        ...
        <div class="home">
            ...
            <div class="home_content">
                <div class="home_title">My Homestays</div>
            </div>
        </div>
    ...
    <div class="container">
        <form action="homestay_add.jsp" method="post">                        
            <button  class="button search_button">ADD HOMESTAY</button>
        </form>
                        ...
                        <div class="offers_grid">
                            ...
                            <div class="offers_item rating_4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="offers_content">
                                            ...
                                            <div class="button book_button"><a  href="SelectMyRoomServlet?HomeStayName=${hs.name}&Detail=${hs.detail}&longtitude=${hs.longtitude}&latitude=${hs.latitude}&phone=${hs.phone}">View<span></span><span></span><span></span></a></div>
                                            <div class="button book_button3"><a href="ToEditHomestayServlet?HomeStayName=${hs.name}">Edit<span></span><span></span><span></span></a></div>
                                            <div class="button book_button2"><a id="delete" onclick="return confirm_click();" href="DeleteHomestayServlet?HomeStayName=${hs.name}">Delete<span></span><span></span><span></span></a></div>
                                ...
                                <script type="text/javascript">
                                    ...
                                    {
                                        return confirm("Do you want to delete your homestay?");
                                    }
