                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 text-lg-right">
                                                    <div class="room_button">
                                                        <div class="button book_button trans_200"><a href="CheckDateServlet?HomestayName=<%= room.get(i).getHomestayName()%>&Rooms=<%= room.get(i).getRoomName()%>&Phone=<%=request.getAttribute("Phone")%>&Cost=<%= room.get(i).getCost()%>">book<span></span><span></span><span></span></a></div>
                                                    </div>
                                                </div>
                                            </div>	
                                        </div>
