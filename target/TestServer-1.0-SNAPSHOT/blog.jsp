    ...
    <header>
        ...
        <div class="super_container">
            ...
            <body>
                ...
                <div class="home">
                    <div class="home_background parallax-window" data-parallax="scroll" data-image-src="https://s3-ap-southeast-1.amazonaws.com/togetherpic/onweb/blog_background.jpg"></div>
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="blog_post_container">
                                    ...
                                    <div class="blog_post">
                                        <div class="blog_post_image">
                                            <img src="<%=blogs.get(i).getImage()%>" alt="https://unsplash.com/@anniespratt" style="height: 500px">
                            ...
                            <div class="col-lg-4 sidebar_col">
                                ...
                                <!-- Sidebar Archives -->
                                <button <%=CheckHidden%> class="btn" onclick="window.location.href = 'create_post.jsp'" /><i class="fa fa-plus"></i>&nbsp Create Blog</a></button>
                                    ...
                                    <div class="latest_posts_container">
                                        <ul>
                                            <%
                                                ...
                                                ArrayList<Blog> blogs1 = (ArrayList<Blog>) request.getAttribute("blogs");
                                                for (int i = 0; i < 4; i++) {
                                                    String date = blogs.get(i).getPostDate();
                                                    String day = date.substring(0, 2);
                                                    String month = date.substring(3, 5);
                                                    String year = date.substring(6, 10);
                                                    int numrandom = (int) (blogs1.size() - 1) - i;

                                            %>
                                            <!-- Latest Post -->
                                            <li class="latest_post clearfix">
                                                <div class="latest_post_image">
                                                    <img src="<%=blogs1.get(numrandom).getImage()%>" alt="" style="width: 70px; height: 70px;"></a>
                                                </div>
                                                <div class="latest_post_content">
                                                    <div class="latest_post_title trans_200"><a href="ViewBlogServlet?PosterldName=<%=blogs1.get(numrandom).getPosterldName()%>&postname=<%=blogs1.get(numrandom).getPostName()%>"><%=blogs1.get(numrandom).getPostName()%></a></div>
                                                    <div class="latest_post_meta">
                                                        <div class="latest_post_author trans_200"><a href="ProfileServlet?user=<%=blogs1.get(numrandom).getPosterldName()%>"><%=blogs1.get(numrandom).getPosterldName()%></a></div>
                                                        <div class="latest_post_date trans_200"><%=blogs1.get(numrandom).getPostDate()%></a></div>
                                                    </div>
                                                </div>
                                            </li>
                                            <%}%>
