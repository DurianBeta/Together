    ...
    <body>
        ...
        <div class="home">
            ...
            <div class="home_content">
                <div class="home_title">Reservation History View</div>
            </div>
						...
						<div class="col fill_height no-padding">
							...
							<div class="search_tabs_container">
								<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
									<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/.png" alt=""><span>Sort by Month</span></div>
									<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/.png" alt="">Rooms</div>
							...
							<div class="search_panel active">
									...
									<form method="POST" action="HistoryOwnerByMonthServlet" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
									<div class="search_item">
										<div>Month</div>
										<select id="country" name="month" class="destination search_input">
									...
									<div class="search_item">
										<div>year</div>
										<select name="years" id="country" class="destination search_input">
											<option value="all">All</option>
									...
									<input type="hidden"  name="Myhomes" value="<%=request.getAttribute("Homestayss")%>">
                                                                            <button class="search_button" style="margin-top: -5px;">
                                                                                <span>
                                                                                    Submit
							...
							<div class="search_panel">
								<form action="HistoryOwnerByRoomsServlet" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                                                                   
									
									<div class="search_item">
										<div>Room</div>
										 <select id="country" name="rooms" class="destination search_input">
                                                                                            <%

                                                                                                ArrayList<Rooms> room = (ArrayList<Rooms>) request.getAttribute("rooms");
                                                                                                for (int i = 0; i < room.size(); i++) {

                                                                                            %>
                                                                                            <option value="<%= room.get(i).getRoomName()%>"><%= room.get(i).getRoomName()%></option>
                    ...
                    <div class="table100">
                        ...
                        <table>
                            ...
                            <%
                                ...
                                ArrayList<Reservations> reservations = (ArrayList<Reservations>) request.getAttribute("reservationMany");
