...
<body>
    ...
    <%
        ...
        ArrayList<Rooms> room = (ArrayList<Rooms>) request.getAttribute("t");
    ...
    <div class="container">
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-1680-4">
                                    <div class="offers_image_container">
                                        ...
                                        <div class="offers_image_background" style="background-image:url(https://s3-ap-southeast-1.amazonaws.com/togetherpic/images/<%= room.get(i).getHomestayName()%>0.jpg)"></div>
                                        <div class="offer_name"><a href="SelectRoom?HomeStayName=<%= room.get(i).getHomestayName()%>"><%= room.get(i).getHomestayName()%> </a></div>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="offers_content">
                                        ...
                                        <br><br>
                                        <p style="color: darkgreen; font-size: 18px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%= room.get(i).getDetail()%></p>


                                        <div class="button book_button"><a href="SelectRoom?HomeStayName=<%= room.get(i).getHomestayName()%>&Detail=<%= room.get(i).getDetail()%>&longtitude=${hs.longtitude}&latitude=${hs.latitude}">book<span></span><span></span><span></span></a></div>
            ...
            <hr style="border-color: lime; border-style: solid;">
