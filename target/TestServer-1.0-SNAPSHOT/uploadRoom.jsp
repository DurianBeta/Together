 ...
 <header class="header">
    ...
    <fieldset>
     ...
     <legend>Upload File</legend>
        ...
        <br>
        <form action="RoomPicUploadS3Servlet"  enctype="multipart/form-data" method="POST">        
                ...
                <input required="please upload image" class="text-center center-block file-upload" id="gallery-photo-add" type="file" name="filename" size="50" multiple accept="image/jpeg"/>

                <input type="hidden" name="homestayNamePic" value="<%=request.getAttribute("homestayName")%>">
                <input type="hidden" name="nameRoomPic" value="<%=request.getAttribute("nameRoomPic")%>">
                <br/><br>
