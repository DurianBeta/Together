                ...
                <div class="wrap-contact100">
                    ...
                    <form class="contact100-form validate-form" action="AddRoomServlet" method="post">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Bathroom amount is required">
                            ...
                            <input class="input100" type="number" name="bathroom" placeholder="Enter amount">
                            <span class="focus-input100"></span>
                        </div>
                        <div class="wrap-input100 validate-input" data-validate = "Bed amount Long is required">
                            ...
                            <input class="input100" type="number" name="bedAmount" placeholder="Enter amount">
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Price is required">
                            ...
                            <input class="input100" type="number" name="cost" placeholder="Enter Price">
                            <span class="focus-input100"></span>
                        </div>

                        <div class="wrap-input100">
                            <span class="label-input100">Detail:</span>
                            <textarea class="input100" name="detail" placeholder="Room Detail"></textarea>
                            <span class="focus-input100"></span>
                        </div>
